        ...
        <Chart
          ...
          data={[
            ...
            [
              "Domésticos",
              !track
                ? DomesticosCategory.length
                : DomesticosCategoryInitial.length,
            ],
            [
              "Espiritual",
              !track
                ? EspiritualCategory.length
                : EspiritualCategoryInitial.length,
            ],
            [
              "Intelectual",
              !track
                ? IntelectualCategory.length
                : IntelectualCategoryInitial.length,
            ],
            [
              "Lazer",
              !track ? LazerCategory.length : LazerCategoryInitial.length,
            ],
            [
              "Profissional",
              !track
                ? ProfissionalCategory.length
                : ProfissionalCategoryInitial.length,
            ],
            [
              "Saúde",
              !track ? SaudeCategory.length : SaudeCategoryInitial.length,
            ],
          ]}
          options={{
            width: "auto",
